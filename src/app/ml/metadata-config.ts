export const mlMetadata = {
  ...
  'neural-network-playground': {
    title:
      'Neural Network Playground - Multi-Layer Perceptron & Backpropagation | Interactive Visualization',
    description:
      'Build and train a small neural network live in your browser. Configure hidden layers and neurons, pick an activation function (ReLU, tanh, sigmoid), and watch backpropagation reshape the decision boundary on circle, XOR, gaussian, and spiral datasets. Explore regularization, weight visualization, and how depth solves problems a single layer cannot.',
    keywords: [
      'neural network playground',
      'neural network',
    ...
    ogImage: '/og/og-ml-neural-network-playground.png',
  },
}
