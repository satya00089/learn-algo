  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="relative overflow-hidden">
        ...
        {/* Hero Section */}
        <section className="relative z-10 px-6 lg:px-8 pt-12 pb-24">
        ...
        <section className="relative z-10 px-6 lg:px-8 pb-20">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-8 border-y border-gray-200 dark:border-gray-800">
              ...
              <div>
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-1">3</div>
              ...
              <div>
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-1">Free</div>
        ...
        <section id="modules" className="relative z-10 px-6 lg:px-8 pb-20">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-lg font-bold text-gray-900 dark:text-white">learn-algo</span>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <li><Link href="/dsa" className="hover:text-gray-900 dark:hover:text-white transition-colors">Data Structures</Link></li>
                  <li><Link href="/ml" className="hover:text-gray-900 dark:hover:text-white transition-colors">Machine Learning</Link></li>
                  <li><Link href="/ai" className="hover:text-gray-900 dark:hover:text-white transition-colors">Artificial Intelligence</Link></li>
                </ul>
              </div>
              <div>
