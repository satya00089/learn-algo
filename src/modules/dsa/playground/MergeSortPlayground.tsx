...
import { useMergeSortPlayground } from '../hooks/useMergeSortPlayground'
import { drawArray } from '../visualizers/sortingVisualizer'

/**
 * Merge Sort Playground
 * Visualizes divide-and-conquer merge sort algorithm
 */
export function MergeSortPlayground() {
  ...
  useEffect(() => {
    ...
    engineRef.current = new MergeSortEngine(initialArray)
  ...
  const getPhaseDescription = () => {
    ...
    switch (engineState.stepPhase) {
      case 'dividing':
        return '✂️ Dividing array into subarrays'
      case 'merging':
        return '🔀 Merging sorted subarrays'
      case 'comparing':
        return '🔍 Comparing elements'
      case 'placing':
        return '📍 Placing element in correct position'
      case 'complete':
      ...
      <div className="h-full flex flex-col">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex-1 flex items-center">
            <Breadcrumbs />
            <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Merge Sort</h1>
          </div>
        ...
        <div className="flex-1 grid lg:grid-cols-4 gap-3 overflow-hidden">
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 flex flex-col min-h-0">
              ...
              <div className="flex items-center justify-center gap-6 pt-3 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-600 dark:text-gray-300">Merging</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="space-y-3 overflow-y-auto min-h-0 pr-2 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-gray-200 dark:[&::-webkit-scrollbar-track]:bg-gray-800 [&::-webkit-scrollbar-thumb]:bg-gray-400 dark:[&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:hover:bg-gray-500 dark:[&::-webkit-scrollbar-thumb]:hover:bg-gray-500">
            ...
            {engineState && (
              <ControlGroup title="Current State">
                <div className="grid grid-cols-2 gap-x-4 gap-y-1.5 text-xs">
                  ...
                  <span className="font-semibold text-right">{engineState.merges}</span>

                  <span className="text-gray-600 dark:text-gray-400">Remaining:</span>
                  <span className="font-semibold text-right">{engineState.mergeStack.length}</span>
            ...
            {/* Algorithm Info */}
            <ControlGroup title="About Merge Sort">
          ...
          >
            ...
            {isRelatedOpen && (
              <div className="px-4 pb-4 pt-2 border-t border-gray-200 dark:border-gray-700 max-h-[60vh] overflow-y-auto">
                <RelatedAlgorithms route="merge-sort" type="dsa" compact />
              </div>
            )}
          </div>
        </div>
        ...
        <TheoryModal
          ...
          theoryFile="/theory/dsa/merge-sort.md"
