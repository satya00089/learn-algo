...
export interface PCA2DCloudSceneProps {
...
export function PCA2DCloudScene({ state, theme }: PCA2DCloudSceneProps) {
  return (
    <PCA2DSpriteScene<CloudMetadata>
      state={state}
      theme={theme}
      ...
      emptyText="Run PCA to see the cloud services"
